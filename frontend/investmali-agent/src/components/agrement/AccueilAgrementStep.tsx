      ...
      <div className="bg-white rounded-lg border border-gray-200 p-4">
        <div className="flex items-center justify-between mb-4">
          <div className="flex items-center space-x-3">
            ...
            <div>
              <h1 className="text-lg font-semibold text-gray-800">Accueil - Demandes d'Agrément</h1>
              <p className="text-sm text-gray-500">Vérification initiale et enregistrement des demandes</p>
            </div>
          </div>
          ...
          <div className="p-4 space-y-4">
            {isLoading ? (
              ...
              <div className="text-center py-8">
                ...
                <h3 className="text-sm font-medium text-gray-900 mb-1">Aucune demande non assignée</h3>
                <p className="text-sm text-gray-500">Toutes les demandes ont été assignées.</p>
              </div>
            ) : (
            ...
            >
              <div className="flex items-center justify-between mb-3">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    {entreprise.sigle && (
                      <p className="text-sm text-gray-500">Sigle: {entreprise.sigle}</p>
                    )}
              ...
              <div className="bg-sky-50 rounded-lg border border-sky-200 p-3 mb-3">
                <div className="flex items-start gap-2">
                  ...
                  <p className="text-sm text-sky-700">Vérifier les documents avant de transmettre à la révision.</p>
                </div>
              </div>
              ...
              <div className="space-y-3">
                <button
                  ...
                  className="w-full bg-sky-600 hover:bg-sky-700 text-white px-4 py-2 rounded-lg font-medium transition-colors disabled:opacity-50 flex items-center justify-center gap-2"
                >
