    ...
    <div className="space-y-6">
      ...
      <div className="flex justify-end">
        <button
          onClick={generatePDF}
<<<<<<< HEAD
          className="bg-sky-600 text-white px-6 py-3 my-5 rounded-xl hover:green-700 flex items-center space-x-2 shadow-lg hover:shadow-xl transition-all duration-300 font-bold"
=======
