          ...
          >
            <div className="text-center">
              ...
              <div className="bg-blue-50 rounded-lg p-4 mb-6">
                <h4 className="font-semibold text-blue-900 mb-2">Avantages inclus :</h4>
          ...
          >
            <div className="text-center">
              ...
              <div className="bg-green-50 rounded-lg p-4 mb-6">
                <h4 className="font-semibold text-green-900 mb-2">Caractéristiques :</h4>
          ...
          >
            <div className="text-center">
              <div className="bg-purple-100 rounded-full p-6 w-20 h-20 mx-auto mb-6 group-hover:bg-purple-200 transition-colors">
                <ShieldCheckIcon className="h-8 w-8 text-purple-600 mx-auto" />
              </div>
        ...
        <div className="mt-16 bg-gradient-to-r from-blue-50 to-indigo-50 rounded-2xl p-8 border border-blue-200">
          <div className="text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <button className="inline-flex items-center px-6 py-3 bg-white text-blue-600 border border-blue-600 rounded-lg hover:bg-blue-50 transition-colors font-semibold">
                Consulter la documentation
              </button>
            </div>
          </div>
          ...
          <div className="bg-white rounded-2xl shadow-2xl max-w-4xl w-full max-h-[90vh] overflow-y-auto">
            ...
            <div className="p-6">
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
                ...
                <div 
                  onClick={() => handleAgrementTypeSelect('nouvelle')}
                  className="bg-gradient-to-br from-blue-50 to-blue-100 border border-blue-200 rounded-xl p-6 hover:shadow-lg hover:scale-105 transition-all duration-300 cursor-pointer group"
                >
                  <div className="text-center">
                    <div className="bg-blue-500 rounded-full p-4 w-16 h-16 mx-auto mb-4 group-hover:bg-blue-600 transition-colors">
                      <PlusIcon className="h-8 w-8 text-white mx-auto" />
                    </div>
                    <h3 className="text-lg font-bold text-gray-900 mb-2">
                      Demande de nouvelle activité
                ...
                <div 
                  onClick={() => handleAgrementTypeSelect('extension')}
                  className="bg-gradient-to-br from-blue-50 to-blue-100 border border-blue-200 rounded-xl p-6 hover:shadow-lg hover:scale-105 transition-all duration-300 cursor-pointer group opacity-75"
                >
                  <div className="text-center">
                    <div className="bg-blue-500 rounded-full p-4 w-16 h-16 mx-auto mb-4 group-hover:bg-blue-600 transition-colors">
                      <ArrowsPointingOutIcon className="h-8 w-8 text-white mx-auto" />
