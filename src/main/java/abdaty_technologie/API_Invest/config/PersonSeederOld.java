...
@Order(1)
@Transactional
public class PersonSeederOld implements CommandLineRunner {
    private static final Logger log = LoggerFactory.getLogger(PersonSeederOld.class);
    ...
    public PersonSeederOld(PersonsRepository personsRepository, 
